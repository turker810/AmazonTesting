...
public class ReusableMethods {
    ...
    public WebElement getNavMenu(String menuName){ //Moda, Elektronkik,
        ...
        WebElement element=Driver.getDriver().findElement(ustMenu);
    ...
    public void navBar(String menuName, String subMenu) throws InterruptedException { //Moda, Elektronkik,
        ...
        WebElement element=Driver.getDriver().findElement(By.xpath("//span[contains(*,'"+menuName+"')]"));

        element.click();
        Thread.sleep(5000);

        WebElement altElm=Driver.getDriver().findElement(By.partialLinkText(subMenu));
        altElm.click();
        Thread.sleep(5000);
    ...
    public void navBar(String menu) throws InterruptedException {
        ...
        WebElement element=Driver.getDriver().findElement(By.xpath("//span[contains(*,'"+menu+"')]"));
        element.click();
    ...
    public List<String> getElementsText2(List<WebElement> list) {
        List<String> elemTexts = new ArrayList<>();
    ...
    public boolean checkNavBar(String menu) throws InterruptedException {
        ...
        Thread.sleep(3000);
        List<WebElement> tumLinkler = Driver.getDriver().findElements(By.xpath("//*[@class='sf-ChildMenuItems-3VA7f']//a"));
        ...
        if(Driver.getDriver().getTitle().contains(subTitle)){
            return true;
        }else{

            System.out.println("Beklenilen Başlık: "+subTitle);
            System.out.println("Gelen Başlık"+Driver.getDriver().getTitle());
            return false;
        }
